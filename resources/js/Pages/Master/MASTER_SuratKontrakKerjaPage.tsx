...
//
// export type FormSuratKontrakKerja = {
//     pegawai_id: string;
//     periode_id: string;
//     amanah: string;
//     onSubmit: boolean;
...
// };
//
// export default function ADMIN_PengajuanPromosiCreatePage({ auth, pegawais, golongans, marhalahs, statusPegawais }: PageProps<{
//     pegawais: Pegawai[];
...
//
//     const formSuratKontrakKerja: FormSuratKontrakKerja = {
