...
export default function MASTER_PegawaiIndexPage({ auth, marhalahs, golongans, statusPegawais, units, pagination, }: PageProps<{
    ...
    const TABLE_HEAD = ['No','NIP', 'Nama', 'Jenis Kelamin', 'Unit', 'Status Pegawai', 'Golongan dan Marhalah', 'Promosi Terakhir', 'Tanggal daftar', 'Aksi'];
