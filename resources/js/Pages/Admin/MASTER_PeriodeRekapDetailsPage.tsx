...
import { JenisPeriodeRekap, jenisPeriodeRekap } from "@/Pages/Admin/MASTER_PeriodeRekapIndexPage";
...
export default function MASTER_PeriodeRekapDetailsPage({ periode }: { periode: PeriodeRekap }) {
