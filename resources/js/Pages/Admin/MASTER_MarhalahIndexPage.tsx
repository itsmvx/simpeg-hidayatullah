...
export default function MasterManageMarhalahPage({ auth, marhalahs, flash }: PageProps<{
    marhalahs: {
        id: string;
        nama: string;
        keterangan: string;
                ...
                <Card className="h-full w-full" shadow={false}>
                    ...
                    <CardBody className="overflow-auto px-0">
                        <table className="mt-4 w-full min-w-max table-auto text-left">
                            ...
                            <tbody>
                                {data.map(({ id, nama, keterangan, created_at }, index) => {
                                            ...
                                            <td className={classes}>
                                                <div className="w-32 flex gap-2.5 items-center justify-start">
                                                    <Tooltip content="Detail">
                                                        <Link href={route('master.marhalah.details', { q: id })}>
