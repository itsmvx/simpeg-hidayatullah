...
import ADMIN_PegawaiCreateFormDataDiri from "@/Components/ADMIN_PegawaiCreateFormDataDiri";

export type ADMIN_FormDataDiriPegawai =  ModelWithoutColumns<FormDataDiri, 'unitId'|'statusPegawaiId'|'marhalahId'|'golonganId'>;
export default function ADMIN_PegawaiDetailsPage({ auth, pegawai }: PageProps<{
    pegawai: ModelWithoutColumns<Pegawai, 'password'|'updated_at'|'unit_id'|'status_pegawai_id'|'golongan_id'|'marhalah_id'> & {
    ...
    const formDataDiriInit: ADMIN_FormDataDiriPegawai = useMemo(() => {
    ...
    return (
        <>
            <Head title="Admin - Details Pegawai"/>
                ...
                <main className="w-full min-h-screen bg-gray-50 space-y-4">
                    ...
                    <Card className="w-full px-6 pt-5">
                        ...
                        <form onSubmit={ handleFormSubmit } className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-4 p-5 dark:bg-gray-900">
                            ...
                            <ADMIN_PegawaiCreateFormDataDiri
