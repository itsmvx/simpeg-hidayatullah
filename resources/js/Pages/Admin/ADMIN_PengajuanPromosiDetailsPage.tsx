...
import { CircleAlert, CircleCheck, CircleX, MoveLeft } from "lucide-react";
import "react-day-picker/dist/style.css";
import { AdminLayout } from "@/Layouts/AdminLayout";
import { IDNamaColumn, PageProps, StatusPengajuanPromosi } from "@/types";
import { format } from "date-fns";
import { id } from "date-fns/locale";
import { Input } from "@/Components/Input";
import { TextArea } from "@/Components/TextArea";

type PengajuanPromosi = {
    id: string;
    nama: string;
    jenis: string;
...
export default function ADMIN_PengajuanPromosiCreatePage({ auth, pengajuanPromosi }: PageProps<{
                ...
                <main className="w-full min-h-screen bg-gray-50 mt-2">
                    ...
                    <Card className="w-full px-6 !shadow-none">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-4 p-5 pb-7">
                            ...
                            />
                            <Typography as="div" className="col-span-full flex items-center gap-1 font-semibold font-sans text-gray-900 capitalize">
                                Status Pengajuan:
                                <span>
                            ...
                            <Typography className="-mt-2 col-span-full flex items-center gap-1 font-semibold font-sans text-sm text-gray-800 capitalize">
