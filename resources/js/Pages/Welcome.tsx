...
const DownloadCVButton = (props) => {
    const createAndDownloadCV = () => {
            ...
            sections: [
                {
                    ...
                    children: [
                        ...
                        new Paragraph({
                            children: [
                                new TextRun({
                                    text: "Detail pendidikan di sini...",
                                    size: 24,
                                }),
                            ],
                            spacing: {
                        ...
                        new Paragraph({
                            children: [
                                new TextRun({
                                    text: "Detail pengalaman kerja di sini...",
                                    size: 24,
                                }),
                            ],
                            spacing: {
        ...
        // Mengekspor dokumen ke format DOCX dan mengunduhnya
    ...
    return <button onClick={createAndDownloadCV}>Download CV</button>;
};

// Contoh penggunaan dalam komponen utama
const App = () => {
    const props = {
        nama: "Indy Adira",
    ...
    return (
        <div>
            <h1>My CV Generator</h1>
            <DownloadCVButton {...props} />
        </div>
    );
};
