...
import PegawaiCreateFormDataDiri from "@/Components/Pegawai/PegawaiCreateFormDataDiri";
import PegawaiCreateFormDataKeluarga from "@/Components/Pegawai/PegawaiCreateFormDataKeluarga";
import PegawaiCreateFormDataPendidikanFormal from "@/Components/Pegawai/PegawaiCreateFormDataPendidikanFormal";
import PegawaiCreateFormDataOrganisasi from "@/Components/Pegawai/PegawaiCreateFormDataOrganisasi";
import PegawaiCreateFormDataPendidikanNonFormal from "@/Components/Pegawai/PegawaiCreateFormDataPendidikanNonFormal";
import PegawaiCreateFormDataPengalamanPPH from "@/Components/Pegawai/PegawaiCreateFormDataPengalamanPPH";
import PegawaiCreateFormDataPengalamanNonPPH from "@/Components/Pegawai/PegawaiCreateFormDataPengalamanNonPPH";

export default function ({ auth, pegawai, golongans, marhalahs, statusPegawais, units }: PageProps<{
    pegawai: Pegawai & {
                ...
                <main className="w-full min-h-screen bg-gray-50 space-y-4">
                    ...
                    <Card className="w-full px-6 pt-5">
                        ...
                        <form onSubmit={handleFormSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-4 p-5">
                            ...
                            <div className="col-span-full grid grid-cols-1 lg:grid-cols-2 gap-x-6 gap-y-4">
                                <div className="relative w-full mb-4">
                                    ...
                                    <input
                                        type="text"
                                        id="golonganId"
                                        value={formDataDiri.golonganId ? golongans.find(g => g.id === formDataDiri.golonganId)?.nama : ''}
                                        disabled
                                ...
                                <div className="relative w-full mb-4">
                                    ...
                                    <input
                                        type="text"
                                        id="marhalahId"
                                        value={formDataDiri.marhalahId ? marhalahs.find(m => m.id === formDataDiri.marhalahId)?.nama : ''}
                                        disabled
                                        className="border border-gray-300 rounded-md w-full py-2 px-3 mt-3 bg-gray-100 text-gray-700"
                                    />
                                </div>
                                ...
                                <div className="relative w-full mb-4">
                                    ...
                                    <input
                                        type="text"
                                        id="statusPegawaiId"
                                        value={formDataDiri.statusPegawaiId ? statusPegawais.find(s => s.id === formDataDiri.statusPegawaiId)?.nama : ''}
                                        disabled
                                        className="border border-gray-300 rounded-md w-full py-2 px-3 mt-3 bg-gray-100 text-gray-700"
                                    />
                                </div>
                            ...
                            <PegawaiCreateFormDataPendidikanFormal
                            ...
                            <PegawaiCreateFormDataPendidikanNonFormal
                            ...
                            <PegawaiCreateFormDataOrganisasi
                            ...
                            <PegawaiCreateFormDataPengalamanPPH
                            ...
                            <PegawaiCreateFormDataPengalamanNonPPH
