    ...
    return (
        <>
            <div className="max-w-lg mx-auto p-6 bg-white rounded-md">
                ...
                <p className="text-sm font-semibold text-gray-900 text-center">
                    Tidak punya template nya? <a href={`/download?file=${btoa('template-upload-data-pegawai.xlsx')}`} className="cursor-pointer text-blue-500 hover:underline" target="_blank">Unduh</a> Template.
                </p>
            </div>
        </>
    );
